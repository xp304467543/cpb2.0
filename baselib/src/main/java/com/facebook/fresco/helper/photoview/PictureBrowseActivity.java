...
public class PictureBrowseActivity extends FragmentActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mItems == null || mItems.size() == 0) {
            LogUtils.INSTANCE.e("photos data is NULL");
            onBackPressed();
            return;
        }
        ...
        LogUtils.INSTANCE.i("mPhotoIndex = " + mPhotoIndex);
        LogUtils.INSTANCE.i("mLongClick = " + mLongClick);
        LogUtils.INSTANCE.i("mPhotoOnlyOne = " + mPhotoOnlyOne);
        LogUtils.INSTANCE.i("isAnimation = " + isAnimation);
        LogUtils.INSTANCE.i("isDragClose = " + isDragClose);
    ...
    public void onPageSelected(int position) {
        ...
        if (mTransitionCompat != null && isAnimation) {
            LogUtils.INSTANCE.i("onPageSelected mPhotoIndex = " + mPhotoIndex);
            mTransitionCompat.setCurrentPosition(mPhotoIndex);
        }
    }
    ...
    public boolean onLongClick(View view) {
        LogUtils.INSTANCE.i("onLongClick");
        return false;
    }
