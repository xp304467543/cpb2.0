 ...
 * }
 * LogUtils.INSTANCE.i("getAbsolutePath = " + fileCacheDir.getAbsolutePath());
 * <p>
...
public class PhoenixConfig {
    ...
    private PhoenixConfig() {
        // FLog.setMinimuLogUtils.INSTANCEgingLevel(FLog.VERBOSE);
    }
            ...
            if (mMemoryTrimmableRegistry == null) {
                ...
                mMemoryTrimmableRegistry.registerMemoryTrimmable(new MemoryTrimmable() {
                    ...
                    public void trim(MemoryTrimType trimType) {
                        ...
                        LogUtils.INSTANCE.i("Fresco onCreate suggestedTrimRatio = " + suggestedTrimRatio);
