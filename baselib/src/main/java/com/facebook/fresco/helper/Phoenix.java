...
//                LogUtils.INSTANCE.i("mDiskCachePath = " + mDiskCachePath);

                if (ImageFileUtils.exists(mDiskCachePath)) {
//                    LogUtils.INSTANCE.i("-->local file already exists");
                                    ...
                                    mSubsamplingScaleImageView.post(new Runnable() {
                                        ...
                                        public void run() {
                                            if(filePath != null) {
                                                ...
                                                LogUtils.INSTANCE.e("filePath = null\t url = " + url);
                                            }
                                        }
                                    });
                                }
...
//                LogUtils.INSTANCE.i("uri = " + uri.toString());
