...
//3S后自动关闭
    ...
    private void createTitleView(String string) {
        //准备Window要添加的View
        ...
        TextView textView = titleView.findViewById(R.id.tvContent);
        ...
        wm_params.width = WindowManager.LayoutParams.MATCH_PARENT;
