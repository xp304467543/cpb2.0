...
public class SpanUtil {
    ...
    public static class SpanBuilder {
         ...
         * @return SpanBuilder
         */
        SpanBuilder addCertainSection(String section, Object span, int flag) {
         ...
         * 添加点击事件
         */
        public SpanBuilder addOnclick(String section, ClickableSpan onClickListener){
            return addCertainSection(section, onClickListener, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        ...
        public SpanBuilder setForeColor(final String section, final int color, boolean ignoreCase, @NonNull Which which) {
            ...
            return onDecor(section, ignoreCase, which, (start, end) -> setForeColor(color, start, end));
        }
        ...
        public SpanBuilder setBackColor(String section, final int color, boolean ignoreCase, @NonNull Which which) {
            ...
            return onDecor(section, ignoreCase, which, (start, end) -> setBackColor(color, start, end));
        }
        ...
        public SpanBuilder setAsSubscript(@NonNull String section, @NonNull Which which) {
            ...
            return onDecor(section, false, which, this::setAsSubscript);
        }
        ...
        public SpanBuilder setAsSuperscript(String section, @NonNull Which which) {
            ...
            return onDecor(section, false, which, this::setAsSuperscript);
        }
        ...
        public SpanBuilder setUnderline(String section, @NonNull Which which) {
            ...
            return onDecor(section, false, which, this::setUnderline);
        }
        ...
        public SpanBuilder setStrikethrough(String section, @NonNull Which which) {
            ...
            return onDecor(section, false, which, this::setStrikethrough);
        }
        ...
        public SpanBuilder setAbsSize(String section, final int size, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setAbsSize(size, start, end));
        }
        ...
        public SpanBuilder setRelSize(String section, final float proportion, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setRelSize(proportion, start, end));
        }
        ...
        public SpanBuilder setAsURL(String section, final String url, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setAsUrl(url, start, end));
        }
        ...
        public SpanBuilder setStyle(String section, final int style, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setStyle(style, start, end));
        }
        ...
        public SpanBuilder setTypeface(String section, final String family, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setTypeface(family, start, end));
        }
        ...
        public SpanBuilder setMask(String section, final MaskFilter maskFilter, @NonNull Which which) {
            ...
            return onDecor(section, false, which, (start, end) -> setMask(maskFilter, start, end));
        }
        ...
        public SpanBuilder removeSpans(@NonNull String section, @NonNull Which which) {
            ...
            return onDecor(section, false, which, this::removeSpans);
        }
