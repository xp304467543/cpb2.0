 ...
 * @ Author  QinTian
 * @ Date  2020-02-16
 * @ Describe 仿 iOS 风格的开关按钮
 */
public class SwitchButtonRed extends AppCompatCheckBox {
     ...
     * 开关选中状态,即打开状态时的背景颜色
     */
    private int mBackgroundColorChecked = 0xFFE03940;
    /**
     * 开关指示器按钮的颜色
     */
    private int mButtonColor = 0xFFFFFFFF;

    public SwitchButtonRed(Context context) {
        this(context, null);
    }

    public SwitchButtonRed(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwitchButtonRed(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRectF = new RectF();
        // 点击时开始动画
        setOnClickListener(v -> startAnimate());
    }
