...
import com.fenghuang.caipiaobao.ui.home.data.HomeTypeListResponse;
 ...
 */
public class HomePageGridView extends FrameLayout {
    public final static int DEFAULT_PAGE_Size = 6;
    public final static int DEFAULT_NUM_COUNT = 3;
    ...
    public final static int DEFAULT_ITEM_VIEW = R.layout.item_view_home;
    ...
    private List<HomeTypeListResponse> mDatas;
    ...
    public HomePageGridView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public HomePageGridView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(List<HomeTypeListResponse> data) {
        this.mDatas = data;
        //总的页数=总数/每页数量，并取整
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            gridViewAdapter.setOnItemClickListener((position, name) -> {
                ...
                if (null != mOnItemClickListener) {
                    mOnItemClickListener.onItemClick(pos, gridViewAdapter.mDatas.get(pos));
                }
            });
        }
        //设置适配器
    ...
    class GridViewAdapter extends BaseAdapter {
        ...
        public GridViewAdapter(Context context, List<HomeTypeListResponse> mDatas, int curIndex, int pageSize) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.ivLiveStatus = convertView.findViewById(R.id.ivLiveStatus);
            ...
            if (null != viewHolder.iv) {
                ImageManager.INSTANCE.loadImg(mDatas.get(pos).getImage(), viewHolder.iv);
            }

            if (mDatas.get(pos).getLive_status() != null && Objects.requireNonNull(mDatas.get(pos).getLive_status()).equals("1")) {
                if (null != viewHolder.ivLiveStatus) {
                    viewHolder.ivLiveStatus.setVisibility(VISIBLE);
                    viewHolder.ivLiveStatus.setGifResource(R.drawable.ic_home_live_gif);
                    viewHolder.ivLiveStatus.play(-1);
                }
            }
        ...
        class ViewHolder {
            ...
            public GifImageView ivLiveStatus;
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, HomeTypeListResponse HomeTypeListResponse);
    }
    ...
    public List<HomeTypeListResponse> getDatas() {
        return mDatas;
    }

    public HomeTypeListResponse getItem(int position) {
