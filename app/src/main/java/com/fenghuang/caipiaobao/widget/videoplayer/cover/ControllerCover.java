...
public class ControllerCover extends BaseCover implements OnTimerUpdateListener, OnTouchGestureListener {
    ...
    public void onReceiverBind() {
        ...
        mRryClose.setOnClickListener(v -> mRestartRoot.setVisibility(View.GONE));

        mRryOpen.setOnClickListener(v -> onRestartListener.restart());

        mBtnvolume.setOnClickListener(v -> setVolume());
