    ...
    private void removeGiftViewAnim(final View view) {
        if (view != null) {
            ...
            if (adapter != null) {
                ...
                post(() -> view.startAnimation(outAnim));
            }
...
//        GiftIdentify bean = queue.poll(3, TimeUnit.SECONDS);
    ...
    public interface OnGiftNum{
        void giftNum(GiftIdentify giftIdentify);
    }

    private OnGiftNum onGiftNum;

    public void setCallBack(OnGiftNum onGiftNum){
