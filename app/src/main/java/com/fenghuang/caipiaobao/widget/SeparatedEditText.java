...
public class SeparatedEditText extends AppCompatEditText {
    ...
    public SeparatedEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderColor = ta.getColor(R.styleable.SeparatedEditText_borderColor, ContextCompat.getColor(getContext(), R.color.grey_light));
        blockColor = ta.getColor(R.styleable.SeparatedEditText_blockColor, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        textColor = ta.getColor(R.styleable.SeparatedEditText_textColor, ContextCompat.getColor(getContext(), R.color.grey_light));
        cursorColor = ta.getColor(R.styleable.SeparatedEditText_cursorColor, ContextCompat.getColor(getContext(), R.color.grey_light));
    ...
    private void drawRect(Canvas canvas) {
        for (int i = 0; i < maxLength; i++) {
            ...
            if (type == TYPE_SOLID) {
                ...
                if (i == 0 || i == maxLength)
                    continue;
                canvas.drawLine(boxRectF.left, boxRectF.top + 10, boxRectF.left, boxRectF.bottom - 10, borderPaint);
            }
        }
